...
let addNewsTopCenterItem = (background, text) => {
	...
	$(".news__top__center__item:last").append("<div class='news__top__center__item__img'></div>");
	$(".news__top__center__item__img:last").css("background", background);
...
listNewsTopCenterItem = [
	{
		background: "url('../../img/8f191c3a75507872f20ceb60da4549a4.png') lightgray -0.589px -299.358px / 100% 237.156% no-repeat",
		text: "ASUS Vivobook S 15 OLED Bape Edition: Chiếc laptop khoác trên"
	},
	{
		background: "url('../../img/190da29fd5a57101069640fd2a990bda.png') lightgray -0.589px -299.358px / 100% 237.156% no-repeat",
		text: "ASUS Vivobook S 15 OLED Bape Edition: Chiếc laptop khoác trên"
	},
]
...
let addNewsTopRightItem = (background, text) => {
	...
	$(".news__top__right__item:last").append("<div class='news__top__right__item__img'></div>");
	$(".news__top__right__item__img:last").css("background", background);
...
listNewsTopRightItem = [
	{
		background: "url('../../img/d0f6564a26152ab5123891558255aaa3.png') lightgray -0.179px -94.116px / 100% 237.156% no-repeat",
		text: "ASUS Vivobook S 15 OLED Bape Edition: Chiếc laptop khoác trên"
	},
	{
		background: "url('../../img/c747b4e497c71103207ad2a3962439f0.png') lightgray -0.179px -94.116px / 100% 237.156% no-repeat",
		text: "ASUS Vivobook S 15 OLED Bape Edition: Chiếc laptop khoác trên"
	},
	{
		background: "url('../../img/60d332144895c522a1f94d22f38e5b16.png') lightgray -0.179px -94.116px / 100% 237.156% no-repeat",
		text: "ASUS Vivobook S 15 OLED Bape Edition: Chiếc laptop khoác trên"
	},
	{
		background: "url('../../img/6b959f991a4d0708bef548c47155e243.png') lightgray -0.179px -94.116px / 100% 237.156% no-repeat",
		text: "ASUS Vivobook S 15 OLED Bape Edition: Chiếc laptop khoác trên"
	},
	{
		background: "url('../../img/b58876b8d2504d03a8a9106014bba06b.png') lightgray -0.179px -94.116px / 100% 237.156% no-repeat",
		text: "ASUS Vivobook S 15 OLED Bape Edition: Chiếc laptop khoác trên"
	},
	{
		background: "url('../../img/1a50d2117479cec8d7d244356093d7ec.png') lightgray -0.179px -94.116px / 100% 237.156% no-repeat",
		text: "ASUS Vivobook S 15 OLED Bape Edition: Chiếc laptop khoác trên"
	}
]
...
let addNewsBottomLeftTopItem = (background, text) => {
	...
	$(".news__bottom__left__top__item:last").append("<div class='news__bottom__left__top__item__img'></div>");
	$(".news__bottom__left__top__item__img:last").css("background", background);
...
listNewsBottomLeftTopItem = [
	{
		background: "url('../../img/26bf1bea30b63ce8631ff7d3985bf0a2.png') lightgray -0.589px -299.358px / 100% 237.156% no-repeat",
		text: "ASUS Vivobook S 15 OLED Bape Edition: Chiếc laptop khoác trên"
	},
	{
		background: "url('../../img/b33bf9962320efccc10c19cb885843f6.png') lightgray -0.589px -299.358px / 100% 237.156% no-repeat",
		text: "ASUS Vivobook S 15 OLED Bape Edition: Chiếc laptop khoác trên"
	},
	{
		background: "url('../../img/3fe16492ef165419683db3500955cdf3.png') lightgray -0.589px -299.358px / 100% 237.156% no-repeat",
		text: "ASUS Vivobook S 15 OLED Bape Edition: Chiếc laptop khoác trên"
	},
]
...
let addNewsBottomLeftItem = (selector, background) => {
	...
	$(selector + " .newsItemBottom__box:last").append("<a href='newsDetails.html' class='newsItemBottom__box__img'></a>");
	$(selector + " .newsItemBottom__box__img:last").css("background", background);
...
listNewsBottomLeftItem_1 = [
	"url('../../img/b44d7888366ccbc311772376944f933d.png') lightgray -0.589px -299.358px / 100% 237.156% no-repeat",
	"url('../../img/c87c4133e9dbf965a63edcec95855ff4.png') lightgray -0.589px -299.358px / 100% 237.156% no-repeat",
	"url('../../img/d13333936146e078dea4dabcbc942ade.png') lightgray -0.589px -299.358px / 100% 237.156% no-repeat",
	"url('../../img/ba20d296bfe4d8a7d26b29d8720e3f45.png') lightgray -0.589px -299.358px / 100% 237.156% no-repeat",
	"url('../../img/6e399d7e73780f48d7485e465eddb5ee.png') lightgray -0.589px -299.358px / 100% 237.156% no-repeat",
	"url('../../img/2aff12ed059937d431df6dc21bd7b5ee.png') lightgray -0.589px -299.358px / 100% 237.156% no-repeat",
	"url('../../img/3a8008668488c4ef798dcd233d5248d6.png') lightgray -0.589px -299.358px / 100% 237.156% no-repeat",
]
...
let addNewsBottomRightSidebarItem = (selector, background, text) => {
	...
	$(".newsSidebar__item:last").append("<div class='newsSidebar__item__img'></div>");
	$(".newsSidebar__item__img:last").css("background", background);
...
listNewsBottomRightListItem_1 = [
	{
		background: "url('../../img/efc10348fe14879c4245475edee3b168.png') lightgray -0.179px -94.116px / 100% 237.156% no-repeat",
		text:"ASUS Vivobook S 15 OLED Bape Edition: Chiếc laptop khoác trên"
	},
	{
		background: "url('../../img/f2ccfde215f081ad72c8fee5dbf4a637.png') lightgray -0.179px -94.116px / 100% 237.156% no-repeat",
		text:"ASUS Vivobook S 15 OLED Bape Edition: Chiếc laptop khoác trên"
	},
	{
		background: "url('../../img/e23b4722a9b8107775155ee7b46307a4.png') lightgray -0.179px -94.116px / 100% 237.156% no-repeat",
		text:"ASUS Vivobook S 15 OLED Bape Edition: Chiếc laptop khoác trên"
	},
	{
		background: "url('../../img/e7ab4bc036b5a6df03a85223f027dc08.png') lightgray -0.179px -94.116px / 100% 237.156% no-repeat",
		text:"ASUS Vivobook S 15 OLED Bape Edition: Chiếc laptop khoác trên"
	},
	{
		background: "url('../../img/d4691da5fe88197410c6820f29dfceb0.png') lightgray -0.179px -94.116px / 100% 237.156% no-repeat",
		text:"ASUS Vivobook S 15 OLED Bape Edition: Chiếc laptop khoác trên"
	},
	{
		background: "url('../../img/76ee136881bd6a56df09fad09a63563c.png') lightgray -0.179px -94.116px / 100% 237.156% no-repeat",
		text:"ASUS Vivobook S 15 OLED Bape Edition: Chiếc laptop khoác trên"
	}
]
...
listNewsBottomRightListItem_2 = [
	{
		background: "url('../../img/0f27e93ba740269cb2da4357590c6fb9.png') lightgray -0.179px -94.116px / 100% 237.156% no-repeat",
		text:"ASUS Vivobook S 15 OLED Bape Edition: Chiếc laptop khoác trên"
	},
	{
		background: "url('../../img/1f18417b44d106be9aaedc3a4038b0b1.png') lightgray -0.179px -94.116px / 100% 237.156% no-repeat",
		text:"ASUS Vivobook S 15 OLED Bape Edition: Chiếc laptop khoác trên"
	},
	{
		background: "url('../../img/0123efe74d51ff8b2450dbd397803053.png') lightgray -0.179px -94.116px / 100% 237.156% no-repeat",
		text:"ASUS Vivobook S 15 OLED Bape Edition: Chiếc laptop khoác trên"
	},
	{
		background: "url('../../img/4284a9389c2dd9a85c86bc31b4e8bb1f.png') lightgray -0.179px -94.116px / 100% 237.156% no-repeat",
		text:"ASUS Vivobook S 15 OLED Bape Edition: Chiếc laptop khoác trên"
	},
	{
		background: "url('../../img/e252067a1d242cd30b57af7f797424ff.png') lightgray -0.179px -94.116px / 100% 237.156% no-repeat",
		text:"ASUS Vivobook S 15 OLED Bape Edition: Chiếc laptop khoác trên"
	},
	{
		background: "url('../../img/22a8793ef92615d9d967f5c4877b5ef1.png') lightgray -0.179px -94.116px / 100% 237.156% no-repeat",
		text:"ASUS Vivobook S 15 OLED Bape Edition: Chiếc laptop khoác trên"
	}
]
...
listNewsBottomRightListItem_3 = [
	{
		background: "url('../../img/8f191c3a75507872f20ceb60da4549a4.png') lightgray -0.179px -94.116px / 100% 237.156% no-repeat",
		text:"ASUS Vivobook S 15 OLED Bape Edition: Chiếc laptop khoác trên"
	},
	{
		background: "url('../../img/190da29fd5a57101069640fd2a990bda.png') lightgray -0.179px -94.116px / 100% 237.156% no-repeat",
		text:"ASUS Vivobook S 15 OLED Bape Edition: Chiếc laptop khoác trên"
	},
	{
		background: "url('../../img/d0f6564a26152ab5123891558255aaa3.png') lightgray -0.179px -94.116px / 100% 237.156% no-repeat",
...
listVideoContentItem = [
	"url('../../img/783f5f9206c58dbbe92b1d58c37630d2.png') lightgray -0.589px -299.358px / 100% 237.156% no-repeat",
	"url('../../img/69d4d4156e6656a30e167b6c1b471227.png') lightgray -0.589px -299.358px / 100% 237.156% no-repeat",
	"url('../../img/c4e851a9fdd22eb443aa249d7d475c5c.png') lightgray -0.589px -299.358px / 100% 237.156% no-repeat",
	"url('../../img/363bf0079022f3a295ad3f2f253d952f.png') lightgray -0.589px -299.358px / 100% 237.156% no-repeat",
	"url('../../img/3ff9c4c64ac4082098e18603c30d0c67.png') lightgray -0.589px -299.358px / 100% 237.156% no-repeat",
	"url('../../img/99e807c2c0e7a75d9d8244a865188a61.png') lightgray -0.589px -299.358px / 100% 237.156% no-repeat",
	"url('../../img/1bc5bef670f79e11642ae8f1988ea715.png') lightgray -0.589px -299.358px / 100% 237.156% no-repeat",
	"url('../../img/10ea4013a4b4b37a9a383bdb3abbc74d.png') lightgray -0.589px -299.358px / 100% 237.156% no-repeat",
	"url('../../img/351c2c929dacb214f4048451929c86dc.png') lightgray -0.589px -299.358px / 100% 237.156% no-repeat",
	"url('../../img/52846a4acbe6e512a5314251e3553b1f.png') lightgray -0.589px -299.358px / 100% 237.156% no-repeat",
	"url('../../img/265426cfeda9459165400d539dc8e92f.png') lightgray -0.589px -299.358px / 100% 237.156% no-repeat",
	"url('../../img/3105358c1ed8eccaaf1cf7762be533ec.png') lightgray -0.589px -299.358px / 100% 237.156% no-repeat",
	"url('../../img/b362956068e676e25057d34359a77373.png') lightgray -0.589px -299.358px / 100% 237.156% no-repeat",
	"url('../../img/3cd8b5419b205b3761baad63df7358b6.png') lightgray -0.589px -299.358px / 100% 237.156% no-repeat",
	"url('../../img/7e11aa4ab0fab2bf26b4ba08a4c3a537.png') lightgray -0.589px -299.358px / 100% 237.156% no-repeat",
	"url('../../img/38a09af3facb91d2a85786ae8b64d93a.png') lightgray -0.589px -299.358px / 100% 237.156% no-repeat",
	"url('../../img/e11d849134100ea5bf8deb9732159a02.png') lightgray -0.589px -299.358px / 100% 237.156% no-repeat",
	"url('../../img/4c43610bf6d65ab94845b16da7e76c61.png') lightgray -0.589px -299.358px / 100% 237.156% no-repeat",
	"url('../../img/3340f84766e5f3dca2d8bd9c732db0ee.png') lightgray -0.589px -299.358px / 100% 237.156% no-repeat",
	"url('../../img/ef93eb61545140238ab17f585e1c840a.png') lightgray -0.589px -299.358px / 100% 237.156% no-repeat",
	"url('../../img/e58045bf863e53666870be898604e651.png') lightgray -0.589px -299.358px / 100% 237.156% no-repeat",
	"url('../../img/7c7343172f9ac1719ac9c5ddb78c9fe1.png') lightgray -0.589px -299.358px / 100% 237.156% no-repeat",
	"url('../../img/22b689ca15b204e64fa02dbbe738d567.png') lightgray -0.589px -299.358px / 100% 237.156% no-repeat",
	"url('../../img/90abc910122ac63f0f2efd8689d03c55.png') lightgray -0.589px -299.358px / 100% 237.156% no-repeat"
];
...
listNewsDetailsLeftContent = [
	{
		background: "url('../../img/f93851104474f36909c9ef2ab6a90ed9.png') lightgray 50% / cover no-repeat",
	...
	{
		background: "url('../../img/044f2b74543dbbe81c79fc3b45fd9bed.png') lightgray 50% / cover no-repeat",
	...
	{
		background: "url('../../img/1d1d62aaf05c4b106f21b29ac62d98dc.png') lightgray 50% / cover no-repeat",
	...
	{
		background: "url('../../img/a2b8e06509041071acc62b5b79e9144e.png') lightgray 50% / cover no-repeat",
	...
	{
		background: "url('../../img/d0d8d54d13665bb5fe572125268b2a2a.png') lightgray 50% / cover no-repeat",
	...
	{
		background: "url('../../img/cf43416c18833269610d4bfce25ac46b.png') lightgray 50% / cover no-repeat",
	...
	{
		background: "url('../../img/76c626261fd54208df585ae1d9b3f2a4.png') lightgray 50% / cover no-repeat",
	...
	{
		background: "url('../../img/2f4cda81d1ca702198f8de69be71a458.png') lightgray 50% / cover no-repeat",
	...
	{
		background: "url('../../img/e72bfde490819bbf2609a4267bbd77f2.png') lightgray 50% / cover no-repeat",
		text: "Ngoài ra máy tính cũng cũng có hình nền đặc biệt được thiết kế với tông màu xanh rằn ri như các phụ kiện khác."
	},
	{
		background: "url('../../img/f7dede35617aad010066727ee96d4767.png') lightgray 50% / cover no-repeat",
	...
	{
		background: "url('../../img/19ee28b72a47e27654f9cce95fae8904.png') lightgray 50% / cover no-repeat",
	...
	{
		background: "url('../../img/5b1d54e8e1fed7b0042a7b48292cc757.png') lightgray 50% / cover no-repeat",
		text: "Cạnh phải là nơi đặt cổng nguồn, HDMI 1.4, USB 3.2 Gen 1 Type-A, Thunderbolt 4 USB-C và giắc âm thanh 3.5mm."
	},
	{
		background: "url('../../img/a1e56bda540ef7f086ae0286e0c12e5f.png') lightgray 50% / cover no-repeat",
	...
	{
		background: "url('../../img/2adcdb0bd18169aa2669bbe4b2458783.png') lightgray 50% / cover no-repeat",
	...
	{
		background: "url('../../img/ce2b15830f161d188775e48c507fcc07.png') lightgray 50% / cover no-repeat",
	...
	{
		background: "url('../../img/e1b0fec8bf35f76a4682e26b2642642a.png') lightgray 50% / cover no-repeat",
	...
	{
		background: "url('../../img/255538b8df633d2070e5eeb360e5be8a.png') lightgray 50% / cover no-repeat",
	...
	{
		background: "url('../../img/487212e39dc46eba59645b237cde247f.png') lightgray 50% / cover no-repeat",
		text: "Trackpad có kích thước lớn đem tới trải nghiệm sử dụng thoải mái và mượt mà."
	},
	{
		background: "url('../../img/52648bddd509962821d1540f7680e57f.png') lightgray 50% / cover no-repeat",
	...
	{
		background: "url('../../img/e7ba8b4370f49b8e4440e642f862b52a.png') lightgray 50% / cover no-repeat",
	...
	{
		background: "url('../../img/bb4c41d901eb1ae71d35c782b6af4952.png') lightgray 50% / cover no-repeat",
...
listPaymentInstructionsSectionWrapCard_1 = [
	{
		background: "url('../../img/1e3d7d069ec33b2c7f36ecf483a4a305.png') lightgray 50% / cover no-repeat",
		text: "Thanh toán chuyển khoản"
	},
	{
		background: "url('../../img/54cee625c4af5e6771d51f075f0e8da2.png') lightgray 50% / cover no-repeat",
		text: "Thanh toán trực tiếp"
	},
	{
		background: "url('../../img/7af46cd512918a3878d5574563e12b92.png') lightgray 50% / cover no-repeat",
...
listPaymentInstructionsSectionWrapCard_2 = [
	{
		background: "url('../../img/a137739c9232eb6715ebeda9664c0131.png') lightgray 50% / cover no-repeat",
		text: "Thanh toán Ví điện tử MoMo"
	},
	{
		background: "url('../../img/c47eb93fd27f65a4f1b85cd84d49f899.png') lightgray 50% / cover no-repeat",
...
addPaymentInstructionsSectionGroupImg(".paymentInstructions__section__group__img:nth-child(1)", "url('../../img/c47eb93fd27f65a4f1b85cd84d49f899.png') lightgray 50% / cover no-repeat");
addPaymentInstructionsSectionGroupImg(".paymentInstructions__section__group__img:last", "url('../../img/7af46cd512918a3878d5574563e12b92.png') lightgray -16px -27.451px / 112.355% 121.198% no-repeat");
...
listWarrantyPolicyBottomContactCardImg = [
	"url('../../img/66adc58b74858ee4e7de6715d672c643.png') no-repeat center #FFF",
	"url('../../img/957a73977007f9ea18dd77e024113eb0.png') no-repeat center #FFF",
	"url('../../img/28719efd2e441f57aded97364a0af7a0.png') no-repeat center #FFF",
	"url('../../img/97751cf5a7899f1955106b1ac8a3c03d.png') no-repeat center #FFF",
	"url('../../img/4b2f484791a466d1f3c99a8d743f7637.png') no-repeat center #FFF"
]
